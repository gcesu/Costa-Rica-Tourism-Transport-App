          ...
          <div className="mt-6 border-t border-gray-200 pt-6">
            <div className="text-sm text-gray-600">
              ...
              <div className="space-y-1">
                <p><strong>Master:</strong> master@transport.com / master123</p>
                <p><strong>Admin:</strong> admin@transport.com / admin123</p>
                <p><strong>Conductor:</strong> juan@transport.com / driver123</p>
                <p><strong>Cliente:</strong> ana@email.com / customer123</p>
              </div>
            </div>
          </div>
        </form>
